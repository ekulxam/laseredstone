...
public class LaserBlockEntityRenderer<T extends LaserBlockEntity> extends BeaconRenderer<T> {
    ...
    protected static final Map<Direction, Consumer<PoseStack>> DIRECTION_TRANSFORMS = ImmutableMap.<Direction, Consumer<PoseStack>>builder()
            .put(Direction.UP, Consumers.nop())
            .put(Direction.DOWN, matrixStack -> matrixStack.mulPose(Axis.XP.rotationDegrees(180)))
            .put(Direction.NORTH, matrixStack -> matrixStack.mulPose(Axis.XN.rotationDegrees(90)))
            .put(Direction.SOUTH, matrixStack -> matrixStack.mulPose(Axis.XP.rotationDegrees(90)))
            .put(Direction.EAST, matrixStack -> matrixStack.mulPose(Axis.ZN.rotationDegrees(90)))
