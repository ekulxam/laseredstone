...
dependencies {
    ...
    localRuntime("maven.modrinth:sodium:${property("deps.sodium_version")}")
    localRuntime("com.terraformersmc:modmenu:${property("deps.modmenu_version")}")
}
...
fletchingTable {
    mixins.create("main") {
        ...
        mixin("default", "${project.property("archives_base_name")}.mixins.json") {
            env("CLIENT", "${project.property("maven_group")}.mixin.client")
        }
    }
    mixins.all {
        automatic = true
